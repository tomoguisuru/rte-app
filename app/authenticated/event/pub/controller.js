...
export default class PublisherController extends Controller {
    ...
    async initPcastExpress() {
        ...
        const authToken = await this.channelExpressService.getToken(authOptions, 'auth');
    ...
    async publishToChannel() {
        ...
        const publishToken = await this.channelExpressService.getToken(publishOptions, 'publish');
